create table aulas (id int4 generated by default as identity, descricao varchar(255), nome varchar(255), modulo_id int4, primary key (id));
create table modulos (id int4 generated by default as identity, nome varchar(255), primary key (id));
alter table if exists aulas add constraint FK5mcbd5kimd5m4nfqsnxw9lseh foreign key (modulo_id) references modulos;
